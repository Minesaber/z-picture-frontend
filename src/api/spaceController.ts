...
export async function addSpaceUsingPost(
  ...
  return request<API.ResponseLong_>('/api/space/add', {
    method: 'POST',
    headers: {
...
export async function deleteSpaceUsingPost(
  ...
  return request<API.ResponseBoolean_>('/api/space/delete', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function editSpaceUsingPost(
  ...
  return request<API.ResponseBoolean_>('/api/space/edit', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function getSpaceByIdUsingGet(
  ...
  return request<API.ResponseSpace_>('/api/space/get', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function getSpaceVoByIdUsingGet(
  ...
  return request<API.ResponseSpaceVO_>('/api/space/get/vo', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function listSpaceLevelUsingGet(options?: { [key: string]: any }) {
  return request<API.ResponseListSpaceLevelDetailVO_>('/api/space/list/level', {
    method: 'GET',
    ...(options || {}),
  })
}
...
export async function listSpaceByPageUsingPost(
  ...
  return request<API.ResponsePageSpace_>('/api/space/list/page', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listSpaceVoByPageUsingPost(
  ...
  return request<API.ResponsePageSpaceVO_>('/api/space/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function updateSpaceUsingPost(
  ...
  return request<API.ResponseBoolean_>('/api/space/update', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
