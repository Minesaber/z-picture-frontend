  ...
  <div id="spaceManagePage">
    <a-flex justify="space-between">
      ...
      <a-space>
        ...
        <a-button type="primary" ghost href="/space_analyze?queryPublic=true" target="_blank"
          >分析公共图库
        </a-button>
        <a-button type="primary" ghost href="/space_analyze?queryAll=true" target="_blank"
          >分析全部空间
        </a-button>
      </a-space>
    </a-flex>
